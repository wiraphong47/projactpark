...
<head>
    ...
    <style>
        ...
        #map-container img {
            ...
            border: 2px solid black; /* เพิ่มเส้นกรอบสีดำ */
        }
    </style>
</head>
<body>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            spots.forEach(spot => {
                spot.addEventListener('click', function() {
                    if (this.classList.contains('available')) {
                        // ลบ class 'selected' ออกจากทุกที่จอด
                        spots.forEach(s => s.classList.remove('selected'));
                        
                        // เพิ่ม class 'selected' ให้กับที่จอดที่ถูกคลิก
                        this.classList.add('selected');
                        
                        // ตั้งค่า input field
                        selectedSpotId = this.dataset.spotId;
            ...
            function showMap() {
                // อัปเดตเนื้อหาใน map-container เพื่อแสดงรูปภาพแผนที่
                mapContainer.innerHTML = `
                    <h2>แผนที่แสดงตำแหน่งที่จอด</h2>
                    <p>แสดงตำแหน่งของลานจอดรถ: <strong>ที่จอดรถเซ็นทรัลพลาซา อุดรธานี</strong></p>
